  ...
  const Cari = async (e) => {
    ...
    if (idrs != "") {
      try {
        ...
        const results = await axiosJWT.get(
          "/apisirs/rltigatitikdelapanadmin",
          customConfig
        );


        const rlTemplate = results.data.data.map((value, index) => {
          return {
            id: value.id,
            groupId:
      ...
      <div className="row">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <form onSubmit={Validasi}>
                ...
                {/* </div> */}
                {/* <div className="form-floating" style={{ width: "100%", display: "inline-block" }}>
                  <textarea name="catatan" type="text" className="form-control" id="floatingInputCatatan" disabled={validateAccess}
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-body">
              <form onSubmit={Cari}>
                <h5 className="card-title h5">Filter RL 3.8</h5>
                <div
      ...
      <div className="row mt-3 mb-3">
        <div className="col-md-12">
          ...
          >
            <thead>
              <tr>
                <th style={{ width: "3%", textAlign: "center", verticalAlign: "middle" }}>No Kegiatan</th>
                <th style={{ width: "5%", textAlign: "center", verticalAlign: "middle" }}>RL</th>
                ...
                <th style={{ width: "20%", textAlign: "center", verticalAlign: "middle" }}>Jenis Kegiatan</th>
                <th style={{ width: "10%", textAlign: "center", verticalAlign: "middle" }}>Jumlah</th>
              </tr>
            </thead>
            <tbody>
